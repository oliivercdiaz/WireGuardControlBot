...
3. **Revisa/ajusta la configuración de WireGuard**
   - `configs/templates/server.conf`: plantilla que usa el contenedor `linuxserver/wireguard`. Sus reglas `PostUp/PostDown` detectan la interfaz de salida real y aplican `MASQUERADE` para dar Internet a los clientes.
